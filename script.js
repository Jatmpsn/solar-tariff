...
// ---------------------------------------------------------------------------
// Blends the raw battery simulation with the no-battery baseline so the
// battery only achieves BATTERY_EFFECTIVENESS (70%) of its theoretical
// single-day benefit. This produces realistic annual cost estimates.
...
function runEngine(bundledTariffs, importTariffs, exportTariffs, houseSize, bedrooms, solarKwp, batteryKwh, location) {
  ...
  // No-battery baseline (used for effectiveness blending)
